    ...
    <tbody>
        <?php foreach ($category as $index => $kategori) : ?>
            <tr>
                ...
                <td><?php echo $kategori['status'] ? "Aktif" : "Non Aktif" ?></td>
            ...
            <div class="modal fade" id="editModal-<?= $kategori['id'] ?>" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('produk-kategori/edit/' . $kategori['id']) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="category_name">Nama</label>
                                    <input type="text" name="category_name" class="form-control" id="category_name" value="<?= $kategori['category_name'] ?>" placeholder="Nama Kategori" required>
                                </div>
                                <div class="form-group">
